...
public class TemperatureReflectionService
{
    ...
    public double ConvertCelsiusToFahrenheit(double celsius)
    {
        ...
        {
            throw new InvalidOperationException($"Ошибка при вызове метода конвертации: {e.Message}", e);
        }
    }
